...
import { CreateKitchenStaffArgs } from "./CreateKitchenStaffArgs";
import { UpdateKitchenStaffArgs } from "./UpdateKitchenStaffArgs";
...
export class KitchenStaffResolverBase {
  ...
  async createKitchenStaff(
    @graphql.Args() args: CreateKitchenStaffArgs
  ): Promise<KitchenStaff> {
  ...
  async updateKitchenStaff(
    @graphql.Args() args: UpdateKitchenStaffArgs
  ): Promise<KitchenStaff | null> {
    try {
